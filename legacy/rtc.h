...
#define USE_TRANSCEIVER_CC2520  //uncomment only for testing
...
public:
     ...
     * is used, this function just returns the current time
     */
    virtual unsigned long long getPacketTimestamp() const=0;
...
public:
     ...
     * No input capture used, this is the same as getValue()
     */
    unsigned long long getPacketTimestamp() const;
 ...
 *          4 used as Input capture for synchronize function
 * 
 */
class VHT : public Timer
{
