 ...
 ***************************************************************************/
#ifndef NON_MONOTONIC_CLOCK_H
#define	NON_MONOTONIC_CLOCK_H
...
public:
     ...
     */
     unsigned long long localTime(unsigned long long slotGlobalTime);
    

    unsigned long long globalTime(unsigned long long slotLocalTime);
