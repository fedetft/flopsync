...
build('test_cc2520/test_cc2520_n0.cpp','node0.bin','node0.elf')
	or die("perl: error while compiling test_cc2520_n0\n");
build('test_cc2520/test_cc2520_n1.cpp','node1.bin','node1.elf') 
	or die("perl: error while compiling test_cc2520_n1\n");
